...
<div id="control-area">
  <ul id="preferences-menu">
    ...
    <#if userLogin?exists>
      ...
      <#-- disabling themes link <li><a href="<@ofbizUrl>ListVisualThemes</@ofbizUrl>">${uiLabelMap.CommonVisualThemes}</a></li> -->
    <#else>
      <li><a href="<@ofbizUrl>${checkLoginUrl}</@ofbizUrl>">Login</a></li>
    </#if>
    <li class="first"><a href="<@ofbizUrl>ListLocales</@ofbizUrl>">Title</a></li>
    <#if userLogin?exists>
